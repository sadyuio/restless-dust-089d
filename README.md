...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/restless-dust-089d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/restless-dust-089d
```

A live public deployment of this template is available at [https://restless-dust-089d.templates.workers.dev](https://restless-dust-089d.templates.workers.dev)
